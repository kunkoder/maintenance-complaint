...
public class DashboardService {
    ...
    public List<StatusCountDTO> getStatusCounts(LocalDateTime startDate, LocalDateTime endDate) {
        if (startDate == null || endDate == null) {
            // Return all-time counts
            return dashboardRepository.countByStatusAllTime();
        } else {
            return dashboardRepository.countByStatusInRange(startDate, endDate);
        }
    }
